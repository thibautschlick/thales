...
-->
			...
			<!--<br/>-->
				...
				<p class="center">
				<?php
                    //INCLUDE DES TROIS BOUTONS : COMPRENDRE - SIMULER - SOUSCRIRE 
					foreach ($ELEMENTS_BULLES as $el)
					{
						...
						// === MASQUé le 13/11/15 fin de la période
								if(1 == 1)  // Accès au site de souscription
								{
									if($form == 'sip')
									{
									...
									{
										echo '<a href="https://www.ors.amundi-ee.com/a/cp/Thales2017?langue='.$langue_banque[$langue].'" class="btn_couleur_turq" target="_blank">'.$lang['menu_caroussel_'.$el].'</a>';
									}
								}
								else
								{
						...
						//===
								...
								{
//									$message = "The subscription period is now over.";
//									if ($langue == 'fr') {$message = "La période de souscription est maintenant terminée.";}
//									echo '<a onclick="alert(\''.$message.'\');" class="btn_couleur_turq">'.$lang['menu_caroussel_'.$el].'</a>';
								}
